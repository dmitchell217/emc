  ...
  ! function(t, e, i) {
      ...
      return n = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), isWebkit = /safari|chrome/i.test(navigator.userAgent), s = function() {
          ...
          return s.prototype.Defaults = {
            ...
            try {
          return isWebkit && (this.$target.is("input:-webkit-autofill") ? this.$element.addClass("auto-fill") : this.$element.removeClass("auto-fill")), this;
        }
        catch(error) {
          console.error(error);
          ...
          return this.$element.removeClass("auto-fill"), this;
        }
              
          }, s.prototype.change = function() {
            try {
          return isWebkit && (this.$target.is("input:-webkit-autofill") ? this.$element.addClass("auto-fill") : this.$element.removeClass("auto-fill")), "" !== this.$target.val() ? (this.$element.hasClass("focus") || this.focus(), this.$element.addClass("not-empty")) : this.$element.removeClass("not-empty"), this;
        }
        catch(error) {
          console.error(error);
          // expected output: ReferenceError: nonExistentFunction is not defined
          ...
          return this.$element.removeClass("not-empty"), this;
        }
